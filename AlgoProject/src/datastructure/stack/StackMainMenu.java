...
public class StackMainMenu {
	...
	public static void main(String[] args) {
		...
		while(true) {
			System.out.println();
			System.out.println("1. push | 2. pop | 3. peek | 4. showStack | 5. size | 6. Capacity | 7. 종료");
			...
			switch(menu) {
			case 1 :
				System.out.println("여러 문자 입력시 첫문자만 입력됩니다.");
			...
			case 5 :
				...
				break;
			case 6 :
				System.out.println("전체 stack 용량 : " + s.getCapacity());
				break;
			case 7 :
