...
public class WildCardEx {
	...
	// 학생 과정
	public static void registerCourseStudent(Course<? extends Student> course) { // Student 클래스 기중 자신과 자식클래스만
		System.out.println(course.getName() + "수강생 : " + Arrays.toString(course.getStudents()));
	}
	
	// 일반 직장인 과정
	public static void registerCourseWorker(Course<? super Worker> course) { // Worker 클래스 기중 자신과 부모클래스만
		System.out.println(course.getName() + "수강생 : " + Arrays.toString(course.getStudents()));
	}
