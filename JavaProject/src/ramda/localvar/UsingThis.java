...
public class UsingThis {
	...
	class Inner{
		...
		void method(int arg) {
			// 로컬 변수 생성 후 수정하지 않으면 람다식에서 final 로 인식 사용 가능
			int localVar = 40;
			int localVar2;
			localVar2 = 60;
			
			localVar2 += 20; // 로컬 변수 수정하면 람다식에서는 사용 불가능
			...
			IMyFunctionalInterface fi = () -> {
				...
				// System.out.println("localVar2 : " + localVar2); // final 이 아니므로 오류
				...
				// 바깥 클래스 중첩 클래스 필드의 이름이 같은 경우 inner 클래스 접근
