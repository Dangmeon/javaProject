...
public class CRUDTestInsert {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String sql = "insert into book values('1000', '자바개정판', '김감자', 18000, '2025-01-15', 5, '2')";
			// statement 객체는 매번 형식 검사(전처리)를 진행함
			// stmt.executeUpdate(sql); // insert, update, delete 문에 사용할 수 있음 -> JDBC가 DBMS에 전달 DBMS의 데이터를 수정하는 것
