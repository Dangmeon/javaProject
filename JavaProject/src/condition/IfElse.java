...
public class IfElse {
	...
	public static void main(String[] args) {
		...
		int score = 85;
		// if 문 (조건이 참인 경우 실행문장만 확인)
		if(score >= 90) 
			System.out.println("등급이 A 입니다."); // if 영역 - 중괄호 없으므로 조건문 바로 아래 한 문장만 if 영역
		...
		// if ~ else 문 (조건이 참인 경우 거짓인 경우 각각 실행 문장을 확인
				if(score >= 90) 
					...
					System.out.println("언제 실행되는 문장인가요?"); // 조건이 참일 때만 실행되는 문장(x) 
				...
				if(score >= 90) {
					...
					System.out.println("언제 실행되는 문장인가요?"); // 조건이 참일때 실행 ? 조건이 거짓일 떄 실행?
