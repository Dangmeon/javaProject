...
public class Switch {
	...
	public static void main(String[] args) {
		...
		String position = sc.nextLine(); // nextLine()은 공백을 포함한 문자열을 입력받는다.(enter 문자도 포함)
		
		switch(position) {
			case "부장":
				System.out.print("700만원"); 
				break;
			case "과장":
				System.out.print("500만원");
			case "대리":
				System.out.print("300만원");
			default:
				System.out.print("200만원");
		}
