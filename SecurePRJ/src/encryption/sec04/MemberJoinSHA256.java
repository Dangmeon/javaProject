...
public class MemberJoinSHA256 {
	...
	public static String sha256(String msg) throws NoSuchAlgorithmException{
		...
		return bytesToHex(md.digest()); // 해시값으로 바꿈
	}
	...
	public static void main(String[] args) throws Exception{
		...
		try {
			...
			pstmt.setString(2, memPass); // 바인딩되는 패스워드 sha256 + 키 스트레칭
...
// 9bb5f1b957a00dbd477c7ef5d325c0f7d28c037b266d97f2d521dd48bdad8287
// 회원가입 성공